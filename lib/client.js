...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const PREF_KEYS = new Set([
      ...
      PREF_PLAYBACK, PREF_PLAYBACK_QQ, PREF_PLAYBACK_KG, PREF_PLAYBACK_NC, PREF_BOOKS_PLAYBACK, PREF_QQ_FAV, PREF_QQ_HISTORY, PREF_QQ_UI, PREF_KG_HISTORY, PREF_NC_HISTORY,
    ...
    function togglePanel() {
      ...
      if (opening) {
        ...
        set({ tab: isNews ? 'news' : (isBook ? 'book' : (isQQ ? 'qq' : (isKG ? 'kg' : (isNC ? 'nc' : 'music')))) });
      }
    ...
    function NowPlayingBar() {
      ...
      if (showQuality && s.currentId !== null && !String(s.currentId).startsWith('qq:') && !String(s.currentId).startsWith('kg:') && !String(s.currentId).startsWith('nc:') && !String(s.currentId).startsWith('book:') && s.currentQuality) {
      ...
      return React.createElement('div', { className: 'dsh-music-panel', ref: panelRef, style: rootStyle },
        ...
        React.createElement('div', { className: 'dsh-music-panel-body' },
          ...
          React.createElement('div', { className: 'dsh-music-tabs' },
            tabBtn('music', '本地音乐'), tabBtn('qq', 'QQ音乐'), tabBtn('kg', '酷狗音乐'), tabBtn('nc', '网易云'), tabBtn('book', 'AI讲书'), tabBtn('news', '新闻播报'), tabBtn('config', '系统配置'), tabBtn('about', '关于')),
          React.createElement('div', { className: 'dsh-music-panel-content' },
            (s.tab === 'qq' || s.tab === 'kg' || s.tab === 'nc' || s.tab === 'news' || s.tab === 'config' || s.tab === 'about') ? null : React.createElement(DirectorySetting, { panelRef }),
