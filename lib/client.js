    ...
    function NowPlayingBar() {
      ...
      return React.createElement('div', { id: 'dsh-music-bar-wrap', className: 'dsh-music-bar-wrap' },
        React.createElement('div',
          ...
          !isBook && hasTrack && s.playing && s.showViz && !s.mirroring ? React.createElement('canvas', { className: 'dsh-music-viz', width: 60, height: 20, ref: (el) => { barCanvasNode = el; } }) : null,
            ...
            hasTrack
              ? (showHint
                  ...
                  : (isBook
                      ...
                      : (isRadio
                          ? (!barDimmed ? React.createElement('span', { className: 'dsh-music-bar-live', title: '网络电台直播' }, s.playing ? '● LIVE' : '电台') : null)
